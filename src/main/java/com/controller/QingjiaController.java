    ...
    */
    ...
    public R save(@RequestBody QingjiaEntity qingjia, HttpServletRequest request){
        ...
        Wrapper<QingjiaEntity> queryWrapper = new EntityWrapper<QingjiaEntity>()
            ...
            .eq("qingjiakaishi_time", new SimpleDateFormat("yyyy-MM-dd").format(qingjia.getQingjiakaishiTime()))
            .eq("qingjia_number", qingjia.getQingjiaNumber())
//            .eq("qingjiajieshu_time", new SimpleDateFormat("yyyy-MM-dd").format(qingjia.getQingjiajieshuTime()))
        ...
        if(qingjiaEntity==null){
            ...
            instance.setTime(qingjia.getQingjiakaishiTime());
            instance.add(Calendar.DAY_OF_MONTH,qingjia.getQingjiaNumber());
            qingjia.setQingjiajieshuTime(instance.getTime());
...
//            qingjia.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<QingjiaEntity> queryWrapper = new EntityWrapper<QingjiaEntity>()
            ...
            .eq("qingjia_name", qingjia.getQingjiaName())
            .eq("qingjia_types", qingjia.getQingjiaTypes())
            .eq("qingjiakaishi_time", qingjia.getQingjiakaishiTime())
            .eq("qingjia_number", qingjia.getQingjiaNumber())
            .eq("qingjiajieshu_time", qingjia.getQingjiajieshuTime())
...
//                            qingjiaEntity.setQingjiaYesnoTypes(Integer.valueOf(data.get(0)));   //请假审核状态 要改的
