<template>
    <div style="backgroundImage: url('/wangshangqingjiaxitong/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">学生网上请假系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="系主任姓名" class="input" v-if="tableName=='xizhuren'">
                            <el-input v-model="ruleForm.xizhurenName" autocomplete="off" placeholder="系主任姓名"  />
                        </el-form-item>
                        <el-form-item label="系主任手机号" class="input" v-if="tableName=='xizhuren'">
                            <el-input v-model="ruleForm.xizhurenPhone" autocomplete="off" placeholder="系主任手机号"  />
                        </el-form-item>
                        <el-form-item label="系主任身份证号" class="input" v-if="tableName=='xizhuren'">
                            <el-input v-model="ruleForm.xizhurenIdNumber" autocomplete="off" placeholder="系主任身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='xizhuren'">
                            <el-input v-model="ruleForm.xizhurenEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.xizhurenName)&& 'xizhuren'==this.tableName){
                                this.$message.error('系主任姓名不能为空');
                                return
                            }
                             if('xizhuren' == this.tableName && this.ruleForm.xizhurenPhone&&(!this.$validate.isMobile(this.ruleForm.xizhurenPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.xizhurenIdNumber)&& 'xizhuren'==this.tableName){
                                this.$message.error('系主任身份证号不能为空');
                                return
                            }
                            if('xizhuren' == this.tableName && this.ruleForm.xizhurenEmail&&(!this.$validate.isEmail(this.ruleForm.xizhurenEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // 学生 的 班级
