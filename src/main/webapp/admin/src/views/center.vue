<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='laoshi'"  label='老师工号' prop="laoshiUuidNumber">
               <el-input v-model="ruleForm.laoshiUuidNumber"  placeholder='老师工号' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xizhuren'"  label='系主任工号' prop="xizhurenUuidNumber">
               <el-input v-model="ruleForm.xizhurenUuidNumber"  placeholder='系主任工号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='xizhuren'"  label='系主任姓名' prop="xizhurenName">
               <el-input v-model="ruleForm.xizhurenName"  placeholder='系主任姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='xizhuren'"  label='系主任手机号' prop="xizhurenPhone">
               <el-input v-model="ruleForm.xizhurenPhone"  placeholder='系主任手机号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='xizhuren'"  label='系主任身份证号' prop="xizhurenIdNumber">
               <el-input v-model="ruleForm.xizhurenIdNumber"  placeholder='系主任身份证号' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
             <el-form-item v-if="flag=='xizhuren'" label='系主任头像' prop="xizhurenPhoto">
                 <file-upload
                         tip="点击上传照片"
                         action="file/upload"
                         :limit="3"
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xizhuren'"  label='电子邮箱' prop="xizhurenEmail">
               <el-input v-model="ruleForm.xizhurenEmail"  placeholder='电子邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
// 注册表的级联表
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.xizhurenUuidNumber)&& 'xizhuren'==this.flag){
                             this.$message.error('系主任工号不能为空');
                             return
                         }

                         if((!this.ruleForm.xizhurenName)&& 'xizhuren'==this.flag){
                             this.$message.error('系主任姓名不能为空');
                             return
                         }

                             if( 'xizhuren' ==this.flag && this.ruleForm.xizhurenPhone&&(!isMobile(this.ruleForm.xizhurenPhone))){
                                 this.$message.error(`手机应输入手机格式`);
                                 return
                             }
                         if((!this.ruleForm.xizhurenIdNumber)&& 'xizhuren'==this.flag){
                             this.$message.error('系主任身份证号不能为空');
                             return
                         }

                         if((!this.ruleForm.xizhurenPhoto)&& 'xizhuren'==this.flag){
                             this.$message.error('系主任头像不能为空');
                             return
                         }

                             if( 'xizhuren' ==this.flag && this.ruleForm.xizhurenEmail&&(!isEmail(this.ruleForm.xizhurenEmail))){
                                 this.$message.error(`邮箱应输入邮箱格式`);
                                 return
                             }
