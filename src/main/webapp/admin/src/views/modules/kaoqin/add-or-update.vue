    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="考勤状态" prop="kaoqinTypes">
                        <el-select v-model="ruleForm.kaoqinTypes" :disabled="ro.kaoqinTypes" placeholder="请选择考勤状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="考勤状态" prop="kaoqinValue">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="考勤日期" prop="kaoqinTime">
                        <el-date-picker
