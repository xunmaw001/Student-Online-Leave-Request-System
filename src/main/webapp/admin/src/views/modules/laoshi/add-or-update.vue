    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="老师工号" prop="laoshiUuidNumber">
                       <el-input v-model="ruleForm.laoshiUuidNumber"
                                 placeholder="老师工号" clearable  :readonly="ro.laoshiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="老师工号" prop="laoshiUuidNumber">
                           <el-input v-model="ruleForm.laoshiUuidNumber"
